 ...
 * * Objetivo: Apresentar o Vizbio e direcionar para o WhatsApp.
...
export const metadata: Metadata = {
  ...
  description: 'Crie um link-na-bio com banners clicáveis em vez de botões. Crie seu perfil visual em minutos.',
  openGraph: {
    title: 'Vizbio.pro',
...
// Ícone de Download (Mantido, pois indica ação de obter algo)
    ...
    <div className="flex flex-col min-h-screen bg-gray-900 text-white font-sans antialiased">
      ...
      <header className="container mx-auto max-w-5xl px-6 py-4">
        <nav className="flex items-center justify-between">
          ...
          {/* BOTÃO 1 - HEADER */}
          <a
            href="https://wa.me/5548920009313"
            target="_blank"
      ...
      <main className="flex-grow">
        ...
        <section className="container mx-auto max-w-3xl px-6">
          <div className="bg-gray-800 rounded-3xl p-4 border border-gray-700 shadow-xl">
            ...
            <img
              src="https://i.ibb.co/BVD9TG91/Screenshot-2025-11-20-22-10-58-641-com-android-chrome-edit.jpg"
        ...
        <section id="download" className="py-20 bg-gray-800 text-center">
          <div className="container mx-auto max-w-3xl px-6">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Fale conosco no WhatsApp para configurar seu
